...
${MANAGE_DATA_ROLE_AND_SECURITY_PROFILES.TEXT.ROLE_STATUS}    //table[@summary = "Search Results"]//tr[.//span[text() ='manage_data_role_status_to_be_replace']]//span[text()="Complete"]
${MANAGE_DATA_ROLE_AND_SECURITY_PROFILES.TEXT.SEARCH_RESULT}    //table[@summary = "Search Results"]//tr[.//span[text() ='manage_data_role_name_to_be_replace']]
